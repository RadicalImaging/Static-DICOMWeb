...
const PatientQuery = [
    PatientID, PatientName, IssuerOfPatientID,
...
const InstanceQuery = [
    Tags.SOPInstanceUID, Tags.InstanceNumber, Tags.SeriesInstanceUID, Tags.StudyInstanceUID,
    Tags.ContentDate, Tags.ContentTime, Tags.AcquisitionDate, Tags.AcquisitionTime,
