  ...
  mkdicomwebConfig: {
    ...
    options: [
      ...
      },
      {
        ...
        description: 'Choose sop instances to run against (only for instance runs)',
      },
      {
        key: '--series-instance-uid <value>',
        description: 'Choose series instances to run against (only for instance runs)',
      },
    ...
    programs: [
      ...
      },
      {
        command: 'server',
        main: serverMain,
        helpDescription: 'Run server deploy instances single threaded/separated exec process',
      },
      {
        command: 'part10',
        arguments: ['studyUID'],
