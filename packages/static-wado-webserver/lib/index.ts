...
import dicomWebServerConfig from "./dicomWebServerConfig";
...
DicomWebServer.dicomWebServerConfig = dicomWebServerConfig;

console.log("dicomWebServerConfig=", dicomWebServerConfig, DicomWebServer);
